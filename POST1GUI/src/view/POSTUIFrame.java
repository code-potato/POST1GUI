...
public class POSTUIFrame extends javax.swing.JFrame {
    ...
    private static Vector<String> UPCs;
     ...
     *
     */
    public Vector<String> getUPCs() {
        for (Map.Entry entry : ProductCatalog.catalog.entrySet()) {
    ...
    public String displayPOST() {
        ...
        Item item = new Item();
        item.setProductSpec(ProductCatalog.getProduct(jComboBox1.getSelectedItem().toString()));
